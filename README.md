...
apenas quando existe ligação à Internet. Mostra até cinquenta notícias numa lista
deslocável, com fonte, grupo, data e resumo; o botão de atualização sincroniza as fontes
antes de substituir o conteúdo.
